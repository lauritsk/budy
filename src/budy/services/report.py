...
def get_volatility_report_data(session: Session, year: int | None) -> dict:
...
def get_weekday_report_data(session: Session) -> list[dict]:
...
def get_yearly_report_data(session: Session, year: int) -> list[dict]:
